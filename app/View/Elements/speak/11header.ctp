...
<div class="wrapper">
          ...
          <div class="col-sm-5 hidden-xs">
            <div class="header-top-left">
			 <ul class="header-top-style text-capitalize mr-25">
			  <li><a href="customer/myaccount"><i class="fa fa-user"></i> Welcome :   <?php if($customer_data) { echo $customer_data['User']['first_name']. " ".$customer_data['User']['last_name']; } else { echo "unknown"; } ?> !</a></li>
 ...
 <?php foreach ($categories as $category_data): ?>	
            ...
            <li><a href="fanbook.html">FANBOOK</a></li>
          	...
          	<div class="col-sm-3 col-xs-6">
            <div class="header-top-right"> <span class="mr-20"><a href="#"><img alt="" src="unknown/images/header/search-icon.png"></a></span> <span>
    ...
    <!-- Mobile Menu End -->
          ...
          <div class="col-sm-4 col-xs-6">
            <div class="header-top-right"> <span class="mr-20"><a href="<?php echo $this->webroot;?>"><img alt="" src="/images/<?php echo $sitelogo; ?>"></a></span> <span>
			  <form action="/unknown/products/search" id="UserSearchForm" method="get" accept-charset="utf-8">
